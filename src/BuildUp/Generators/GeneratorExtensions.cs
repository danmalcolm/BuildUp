...
namespace BuildUp.Generators
{
	...
	public static class GeneratorExtensions
	{
		...
		{
			return Generator.Values(() => generator.Create().Select(selector));
		}
	    ...
	    {
	        return Generator.Values(() => Enumerable.Zip(generator.Create(), other.Create(), get));
	    }
        ...
        /// provides lists of objects to another generator, perhaps to populate a collection 
        /// property of each value generated by the other generator.
        /// </summary>
        /// <typeparam name="TObject"></typeparam>
        /// <param name="generator"></param>
        ...
        public static IGenerator<IEnumerable<TObject>> SequencesOf<TObject>(this IGenerator<TObject> generator,
            int length)
        {
            return Generator.Values(() => CreateSequencesOf(generator, Generator.Constant(length)));
        }
	    ...
	    {
	        return Generator.Values(() => CreateSequencesOf(generator, lengths));
	    }

        private static IEnumerable<IEnumerable<TObject>> CreateSequencesOf<TObject>(IGenerator<TObject> generator, IGenerator<int> lengths)
        {
            var e = generator.Create().GetEnumerator();
            foreach (var length in lengths.Create())
            {
