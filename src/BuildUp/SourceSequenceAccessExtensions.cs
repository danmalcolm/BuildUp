...
{
	/// <summary>
	/// Extension methods for accessing the sequence of objects generated by a source
	/// </summary>
	public static class SourceSequenceAccessExtensions
	{
		/// <summary>
		...
		/// <summary>
		/// Creates a new source that generates an infinite sequence, repeating the first object generated by this source
		/// </summary>
		/// <typeparam name="T"></typeparam>
		/// <param name="source"></param>
		/// <returns></returns>
		...
		/// <summary>
		/// Stores the specified number of elements from the start of the sequence in memory and creates
		/// an infinite sequence that loops over the stored items. 
		/// </summary>
		/// <typeparam name="T"></typeparam>
		/// <param name="source"></param>
		/// <param name="count"></param>
