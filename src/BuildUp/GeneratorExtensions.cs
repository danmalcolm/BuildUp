...
namespace BuildUp
{
	public static class GeneratorExtensions
	{
		...
		{
			return Generator.Create((context, obj) => selector(obj), generator);
		}
		...
		{
			return Generator.Create((context, obj) => { 
				action(obj);
				return obj;
			}, generator);
		}
		...
		public static IGenerator<TResult> SelectMany<TObject, TChild, TResult>(this IGenerator<TObject> generator, Func<IGenerator<TObject>, IGenerator<TChild>> generatorSelector, Func<TObject, TChild, TResult> resultSelector)
		{
			...
			return Generator.Create((context, obj, otherObj) => resultSelector(obj, otherObj), generator, other);
		}
